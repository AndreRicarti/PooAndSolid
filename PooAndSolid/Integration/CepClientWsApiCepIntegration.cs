...
{
    public class CepClientWsApiCepIntegration : CepClientIntegration
    {
        private AdapterCep<ResponseWsApiCep> adapterCep = null;

        public CepClientWsApiCepIntegration(AdapterCep<ResponseWsApiCep> adapterCep)
        {
